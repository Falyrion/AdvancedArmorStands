...
public class CmdSetGravity implements CommandInterface {
            ...
            if (args.length == 3) {
                ...
                if (f <= 100) {
                    ...
                    if (!args[1].equalsIgnoreCase("on") && !args[1].equalsIgnoreCase("off")) {
                        p.sendMessage("§c[AA]§f This command was not used correctly! Please use §b/aa gravity <on/off> <range>");
                    }
                ...
                p.sendMessage("§c[AA] This command was not used correctly! Please use §b/aa gravity <on/off> <range>");
            }
