...
public class CmdSetLeftArmPose implements CommandInterface{
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        ...
        if (p.hasPermission("aa.edit")) {
            ...
            if (args.length == 5) {
                ...
                p.sendMessage("§c[AA] This command was not used correctly! To modify the left arm pose use §b/aa lap <pitch> <roll> <yaw> <range>§6!");
