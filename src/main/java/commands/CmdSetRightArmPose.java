    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        ...
        if (player.hasPermission("aa.edit")) {
            ...
            if (args.length == 5) {
                ...
                if (distance <= AdvancedArmorStandsMain.getInstance().getInstance().getSettings().commandEditRange()) {
                    ...
                    for (Entity entity : player.getNearbyEntities(distance, distance, distance)) {
                        if (entity instanceof ArmorStand armorstand) {
                            ...
                            armorstand.setRightArmPose(newPoseEulerAngle);
                        }
                    }
                ...
                player.sendMessage(ChatColor.RED + message_01 + ChatColor.AQUA + " /aa rap <roll> <yaw> <pitch> <range>");
