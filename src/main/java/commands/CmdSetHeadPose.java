...
public class CmdSetHeadPose implements CommandInterface {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
        ...
        if (player.hasPermission("aa.edit")) {
            ...
            if (args.length == 5) {
                ...
                if (distance <= AdvancedArmorStandsMain.getInstance().getSettings().commandEditRange()) {
                    ...
                    for (Entity entity : player.getNearbyEntities(distance, distance, distance)) {
                        if (entity instanceof ArmorStand armorstand) {
                            ...
                            armorstand.setHeadPose(newPoseEulerAngle);
                        }
                    }
                ...
                player.sendMessage(ChatColor.RED + message_01 + ChatColor.AQUA + " /aa hp <roll> <yaw> <pitch> <range>");
